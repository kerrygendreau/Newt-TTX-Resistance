...
Multiple sequence alignments of all SCNA paralogs found in amphibians and outgroup Danio rerio can be downloaded here: [All SCNAs amino acid alignment](SCNA_protein_alignment_RAxML_Tree.fasta) (Fig. 1 in Gendreau et al. (2021)) and here: [All SCNAs full coding sequence alignment](SCN_CDS_alignment_RAxML_Tree.fasta) (Fig. S2 in Gendreau et al. (2021)).
